...
@media (max-width: 600px) {
  ...
  .remember_me {
    ...
    <script src="<?echo base_url()?>js/register_cloud.js"></script>
  ...
  <div class="form_wrapper">
	<div class="form_container">
		...
		<div class="row clearfix">
			<div class="">
				<form id='register-form' autocomplete="off" method="POST" action="<? echo base_url()?>User/verify_registration">
					<div class="row clearfix">
						<div class="col_half">
					...
					<div class="input_field"> 
						...
						<input type="text" class="input-medium bfh-phone" name="phone" placeholder="Enter your 10 digit Phone No" country="IN" required />
					...
					<!-- <div class="input_field select_option">
						...
						<input name='country' type="text" id="country-list" list="country-datalist" placeholder='Country of Origin' autocomplete="on">
						<span class="text-danger"><?php echo form_error("country"); ?></span>
						<datalist id="country-datalist" autocomplete="on">
						</datalist>
...
<!-- <p class="credit">Developed by <a href="http://www.designtheway.com" target="_blank">Design the way</a></p>
  --> 
  <script src='<? echo base_url() ?>js/register.js'></script>

  

    <script  src="<? echo base_url() ?>js/index.js"></script>
